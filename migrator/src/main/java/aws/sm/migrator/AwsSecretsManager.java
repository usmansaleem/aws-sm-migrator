...
public class AwsSecretsManager implements AutoCloseable {
    ...
    public List<String> getAllSecretsForPrefix(String prefix) {
        ...
        final ListSecretsIterable listSecretsResponses = secretsClient
                .listSecretsPaginator(ListSecretsRequest
                        .builder()
                        .filters(filters)
                        .build());
        ...
        listSecretsResponses.stream().forEach(listSecretsResponse -> {
            final List<String> values = listSecretsResponse.secretList()
                    .parallelStream()
